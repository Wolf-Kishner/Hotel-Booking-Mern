...
export const SearchBar = ({ openPopUp }) => {
  ...
  return (
    <header className="flex py-4 justify-between border-b border-gray-200 ">
      ...
      <div className="flex  justify-center gap-4 border  border-gray-300 rounded-full py-2  px-6 shadow-md shadow-gray-300 ">
        <div>Anywhere</div>
      ...
      <Link
        ...
        className="flex gap-2  rounded-full py-2 px-4"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
